...
import { STAGE_LABELS, ProcessStatus, ProcessStage } from "../types";
...
export default function ProcessList() {
  ...
  // Filtrar processos
  const filteredProcesses = mockProcesses.filter((processo) => {
    const matchesSearch =
      processo.codigo.toLowerCase().includes(searchTerm.toLowerCase()) ||
      processo.imovel.toLowerCase().includes(searchTerm.toLowerCase()) ||
      processo.inquilino.toLowerCase().includes(searchTerm.toLowerCase());

    const matchesStatus =
      statusFilter === "todos" || processo.status === statusFilter;

    const matchesEtapa =
      etapaFilter === "todos" || processo.etapaAtual === etapaFilter;
